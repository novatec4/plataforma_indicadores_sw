...
export const MetricCard: React.FC<MetricCardProps> = ({ title, value, prefix = '', suffix = '', icon: Icon, trendLabel }) => {
    return (
        <div className="bg-white rounded-xl shadow-md p-6 border border-slate-100 flex flex-col justify-center relative overflow-hidden">
            ...
            {trendLabel && <p className="text-xs text-slate-400 font-medium mt-2">{trendLabel}</p>}
        </div>
    );
};